...
{:else if icon === 'aiq'}
  <svg class="tree-icon aiq-file-icon" viewBox="0 0 16 16" aria-hidden="true">
    <path class="query-file-page" d="M3.25 1.5h6.25l3.25 3.25v9.75h-9.5z" />
    <path class="query-file-fold" d="M9.5 1.5v3.25h3.25" />
    <path class="query-file-edge" d="M5.65 7.25 9.9 6.4M6.15 8.15l2 3.05m2.15-3.65-1.1 3.25" />
    <circle class="query-file-node" cx="5.2" cy="7.35" r="1.05" />
    <circle class="query-file-node" cx="10.35" cy="6.25" r="1.05" />
    <circle class="query-file-node" cx="8.65" cy="11.45" r="1.05" />
  </svg>
{:else}
...
<style>
  ...
  .aiq-file-icon .query-file-page,
  .aiq-file-icon .query-file-fold {
    fill: none;
    stroke: currentColor;
    stroke-width: 1;
