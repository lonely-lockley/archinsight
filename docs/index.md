...
- [Built-in Archinsight Types](built-in-types.md) explains the graph foundations, the core C4 hierarchy, deployment types, and built-in relationships.
...
- [C4: Deployment](c4-deployment.md) explains environments, deployment schemes, infrastructure placement, projections, profiles, and physical paths for logical elements and wires.
