...
- [Querying the Architecture Graph](graph-queries.md) describes the semantic graph, saved `.aiq` diagram queries and table reports, built-in overrides, CLI execution, parameters, scope variables, filtering, traversal, aggregation, rollups, projections, and grouping.
